...
parser.add_argument('--name', default='cd92_5h')
parser.add_argument('--save-dir', default='/home/stud_vantuan/share_with_150/cache/cd92.93_95_with_5h_clean_and_5h_noisy/noisy/cluster')
parser.add_argument('--data-dir', default='/home/stud_vantuan/share_with_150/cache/cd92.93_95_with_5h_clean_and_5h_noisy/noisy/train')
