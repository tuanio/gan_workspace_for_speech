...
python train.py \
    ...
    --num_labels_A 100 \
    --num_labels_B 100 \
    --label_A_path /home/stud_vantuan/share_with_150/cache/cd92_10h_9h_cond/label/KMeans_train_clean_cd93_100.clusters \
...
#     --name cond_unet_gan_cond_dim32_unet128_label.clean1_noisy100_10h_9h_200epochs \
#     --model conditional_gan \
#     --model_name unet_128_mask \
#     --dataset_mode audio \
#     --norm instance \
