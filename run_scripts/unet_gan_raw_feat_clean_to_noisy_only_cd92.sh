...
data_cache=/home/stud_vantuan/share_with_150/cache/cd93_and_92_noisy_only
checkpoints_dir=checkpoints/
gpu_ids=0
config=unet128_cd93_to_cd92_noise_only_150epochs
...
python test.py \
    --dataroot /home/stud_vantuan/share_with_150/cache/cd93_and_92_noisy_only \
    --name unet_gan_unet128_cd93_to_cd92_noise_only_150epochs \
    --model unet_gan \
    --dataset_mode audio \
    --norm instance \
    --phase test \
